...
var Item = /** @class */ (function (_super) {
    ...
    Item.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className, style = _b.style, children = _b.children, disabled = _b.disabled, nativeEvent = _b.nativeEvent, propsFromTrigger = _b.propsFromTrigger, data = _b.data;
        var isDisabled = typeof disabled === 'function'
            ? disabled({
                event: nativeEvent,
                props: __assign({}, propsFromTrigger, data)
            })
        ...
        var cssClasses = classnames_1.default(styles_1.styles.item, className, (_a = {},
            _a["" + styles_1.styles.itemDisabled] = isDisabled,
            _a));
